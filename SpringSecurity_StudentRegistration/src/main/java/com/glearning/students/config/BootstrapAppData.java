...
public class BootstrapAppData {
	...
	public void initializeData(ApplicationReadyEvent readyEvent) {
		...
		Student sarath = new Student("Sarath", "Krishnan", "IOT", "India");
		Student jithin = new Student("Jithin", "Raj", "AI", "India");
		Student pruthvi = new Student("Pruthvi", "Assam", "NodeJs", "India");
		Student sai = new Student("Sai", "Kumar", "Java", "India");
		
		this.studentRepository.save(sarath);
		this.studentRepository.save(jithin);
		this.studentRepository.save(pruthvi);
		this.studentRepository.save(sai);
	}
